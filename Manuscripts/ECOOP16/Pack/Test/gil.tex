...
public static void four_use_cases_of_function_f() {
  ¢$\gamma$¢1 _1 = f.r1().s1(); // ¢\cmark¢ ¢$f(r_1,s_1) = \gamma_1$¢
  ¢$\gamma$¢2 _2 = f.r1().s2(); // ¢\cmark¢ ¢$f(r_1,s_2) = \gamma_2$¢
  ¢$\gamma$¢2 _3 = f.r2().s1(); // ¢\cmark¢ ¢$f(r_2,s_1) = \gamma_2$¢
  f.r2().s2().g(); // ¢\xmark¢ method ¢\cc{s2()}¢ undefined in type ¢\cc{\scriptsize $\Gamma$'}¢
}
\end{filecontents*}
...
public static abstract class R { 
  public abstract ¢$\gammaʹ$¢ s1();
  public abstract ¢$\gammaʹ$¢ s2();
  public static final class r1 extends R {
    @Override public ¢$\gamma$¢1 s1() { return null; } 
    @Override public ¢$\gamma$¢2 s2() { return null; }
  }
  public static final class r2 extends R {
    @Override public ¢$\gamma$¢2 s1() { return null; }
    @Override public ¢$\gammaʹ$¢.¢\textcurrency¢ s2() { return null; }
  }
}
\end{filecontents*}
...
public static void five_use_cases_of_function_g() {
  ¢$\gamma$¢2 _1 = new ¢$\gamma$¢1().g(); // ¢\cmark¢
  ¢$\gamma$¢1 _2 = new ¢$\gamma$¢2().g(); // ¢\xmark¢ type mismatch
  ¢$\gammaʹ$¢.¢\textcurrency¢ _3 = new ¢$\gamma$¢2().g(); // ¢\xmark¢ class ¢\textcurrency¢ is private
  ¢$\gammaʹ$¢ _4 = new ¢$\gamma$¢2().g(); // ¢\cmark¢
  _4.g(); // ¢\xmark¢ g() undefined in type ¢$\gammaʹ$¢
}
\end{filecontents*}
\begin{filecontents*}{gamma.listing}
public static abstract class ¢$\Gammaʹ$¢ { 
  private static abstract class ¢\textcurrency¢ extends ¢$\Gammaʹ$¢ {
    // Empty private class, cannot be used by clients.
    private ¢\textcurrency¢() { /* Private constructor hinders extension by clients */ }
  }
  public  static abstract class ¢$\gamma$¢ extends ¢$\gammaʹ$¢ { 
    public abstract ¢$\gammaʹ$¢ g(); 
    public static final class ¢$\gamma$¢1 extends ¢$\gamma$¢ {
      // Covariant return type in overriding:
      @Override public ¢$\gamma$¢2 g() { return null; } 
    }
    public static final class ¢$\gamma$¢2 extends ¢$\gamma$¢ {
      // Covariant return type in overriding:
      @Override  public ¢$\gammaʹ$¢.¢\textcurrency¢ g() { return null; }
    }
  }
} 
\end{filecontents*}
...
interface ¢\textcurrency¢ extends JS<¢\textcurrency¢, ¢\textcurrency¢, ¢\textcurrency¢> {
  @Override public ¢$\gammaʹ$¢.¢\textcurrency¢ top();
  @Override public ¢\textcurrency¢ pop();
  @Override public ¢\textcurrency¢ ¢$\gamma$¢1();
  @Override public ¢\textcurrency¢ ¢$\gamma$¢2();
}
\end{filecontents*}
\begin{filecontents*}{jump-stack-E.listing}
public interface E extends JS<¢\textcurrency¢, ¢\textcurrency¢, ¢\textcurrency¢> {
  @Override public ¢$\gammaʹ$¢.¢\textcurrency¢ top();
  @Override public ¢\textcurrency¢ pop();
  @Override public P<¢$\gamma$¢1, E, E, ¢\textcurrency¢> ¢$\gamma$¢1();
  @Override public P<¢$\gamma$¢2, E, ¢\textcurrency¢, E> ¢$\gamma$¢2();
}
\end{filecontents*}
...
public static void jump_stack_use_cases(){
  P<
    ¢$\gamma$¢1,                             // Top   
    P<¢$\gamma$¢1,P<¢$\gamma$¢2,E,¢\textcurrency¢,E>,P<¢$\gamma$¢2,E,¢\textcurrency¢,E>,E>,// Rest 
    P<¢$\gamma$¢1,P<¢$\gamma$¢2,E,¢\textcurrency¢,E>,P<¢$\gamma$¢2,E,¢\textcurrency¢,E>,E>,// jump(¢$\gamma$¢1) 
    E                               // jump(¢$\gamma$¢2)                      
  > _1 = JS.empty.¢$\gamma$¢2().¢$\gamma$¢1().¢$\gamma$¢1();
  E _2 = _1.jump_¢$\gamma$¢2();
  P<
    ¢$\gamma$¢1,             // Top
    P<¢$\gamma$¢2,E,¢\textcurrency¢,E>,    // Rest
    P<¢$\gamma$¢2,E,¢\textcurrency¢,E>     // jump(¢$\gamma$¢1)
    ,E              // jump(¢$\gamma$¢2)
  > _3 = _1.jump_¢$\gamma$¢1();
}
\end{filecontents*}
...
> {
  ...
  JS ¢$\gamma$¢1();
  JS ¢$\gamma$¢2();
  J_¢$\gamma$¢1 jump_¢$\gamma$¢1();
  J_¢$\gamma$¢2 jump_¢$\gamma$¢2();
  interface ¢\textcurrency¢ extends JS<¢\textcurrency¢, ¢\textcurrency¢, ¢\textcurrency¢> { ¢$…$¢ }
  public interface E extends JS<¢\textcurrency¢, ¢\textcurrency¢, ¢\textcurrency¢> { ¢$…$¢ }
  ...
  public interface P<// ¢$2+k$¢ generic arguments:
      ...
      J_¢$\gamma$¢1 extends JS, 
      J_¢$\gamma$¢2 extends JS
  > extends P¢$ʹ$¢<Top, Rest, J_¢$\gamma$¢1, J_¢$\gamma$¢2, 
        P<Top, Rest, J_¢$\gamma$¢1, J_¢$\gamma$¢2>
  > { /**/ }
}
\end{filecontents*}
...
// ¢$2+k+1$¢ generic arguments: 
  ...
  J_¢$\gamma$¢2 extends JS,
  Me extends JS
> extends JS<Rest, J_¢$\gamma$¢1, J_¢$\gamma$¢2> {
   public Top top();
   P<¢$\gamma$¢1, Me, Me, J_¢$\gamma$¢2> ¢$\gamma$¢1();
   P<¢$\gamma$¢2, Me, J_¢$\gamma$¢2, Me> ¢$\gamma$¢2();
}
\end{filecontents*}
...
public static class Peep<¢$\gamma$¢ extends ¢$\gammaʹ$¢, S extends Stack<? extends Stack<?>>> {}
...
<Top extends ¢$\gamma$¢, Rest extends Stack<?>> // Two generic parameters
...
public static void peeping_into_a_stack_use_cases() {
  P<¢$\gamma$¢2, P<¢$\gamma$¢1, P<¢$\gamma$¢2, P<¢$\gamma$¢1, P<¢$\gamma$¢2, E>>>>> _1 = Stack.empty.¢$\gamma$¢2().¢$\gamma$¢1().¢$\gamma$¢2().¢$\gamma$¢1().¢$\gamma$¢2();
  Peep<¢$\gamma$¢2, P<¢$\gamma$¢2, P<¢$\gamma$¢1, P<¢$\gamma$¢2, P<¢$\gamma$¢1, P<¢$\gamma$¢2, E>>>>>> _2 = peep(_1);
  E _3 = Stack.empty;
  Peep<?, E> _4 = peep(_3);
}
\end{filecontents*}
...
interface ¢\textcurrency¢ { /* Error configuration. */ }
\end{filecontents*}
...
static class A { // Encode automaton ¢$A$¢
  ...
  interface C¢$\gamma$¢1< // Configuration when ¢$\gamma_1$¢ is at top
    Rest, JR¢$\gamma$¢1, JR¢$\gamma$¢2
  > extends 
    ¢$\gamma$¢1¢$σ$¢1_Push_¢$\gamma$¢1¢$\gamma$¢1¢$\gamma$¢2<Rest,JR¢$\gamma$¢1,JR¢$\gamma$¢2,C¢$\gamma$¢1<Rest, JR¢$\gamma$¢1, JR¢$\gamma$¢2>>
  {
    L $();
  }
  interface C¢$\gamma$¢2< // Configuration when ¢$\gamma_2$¢ is at top
    Rest, JR¢$\gamma$¢1, JR¢$\gamma$¢2
  > extends 
    ¢$\gamma$¢2¢$σ$¢1_Push_¢$\gamma$¢2¢$\gamma$¢2<Rest,JR¢$\gamma$¢1,JR¢$\gamma$¢2>
  { 
    Rest ¢$σ$¢2();
    JR¢$\gamma$¢1 ¢$σ$¢3();
  }
  interface ¢$\gamma$¢1¢$σ$¢1_Push_¢$\gamma$¢1¢$\gamma$¢1¢$\gamma$¢2<Rest,JR¢$\gamma$¢1,JR¢$\gamma$¢2,P extends C¢$\gamma$¢1<Rest, JR¢$\gamma$¢1, JR¢$\gamma$¢2 >>{
    // Sidekick of ¢$\delta(\gamma_1,\sigma_1)=\textsf{push}(\gamma_1,\gamma_1,\gamma_2)$¢
    C¢$\gamma$¢2<C¢$\gamma$¢1<P, Rest, JR¢$\gamma$¢2>,P,JR¢$\gamma$¢2> ¢$σ$¢1();
  }
  interface ¢$\gamma$¢2¢$σ$¢1_Push_¢$\gamma$¢2¢$\gamma$¢2<Rest,JR¢$\gamma$¢1,JR¢$\gamma$¢2>{
    // Sidekick of ¢$\delta(\gamma_2,\sigma_1)=\textsf{push}(\gamma_2,\gamma_2)$¢
    C¢$\gamma$¢2<C¢$\gamma$¢2<Rest, JR¢$\gamma$¢1, JR¢$\gamma$¢2>, JR¢$\gamma$¢1, Rest> ¢$σ$¢1();
  }
  static C¢$\gamma$¢1<E,¢\textcurrency¢,¢\textcurrency¢> build = null;
}
\end{filecontents*}
...
interface C<      // Generic parameters:
  ...
  JR¢$\gamma$¢1 extends C, // Type of ¢$~\cc{Rest}.\textsf{jump}(\gamma_1)$¢, may be rest, or anything in it. 
  JR¢$\gamma$¢2 extends C  // Type of ¢$~\cc{Rest}.\textsf{jump}(\gamma_2)$¢, may be rest, or anything in it.  
>
{
  ...
  public interface E extends C<¢\textcurrency¢,¢\textcurrency¢,¢\textcurrency¢> { /* Empty stack configuration */ }
  interface ¢\textcurrency¢ extends C<¢\textcurrency¢,¢\textcurrency¢,¢\textcurrency¢> { /* Error configuration. */ }
}
\end{filecontents*}
...
class A { // Encode automaton ¢$A$¢
  ...
  >
  {
    ...
    { 
      @Override Rest ¢$σ$¢2();
      @Override JR¢$\gamma$¢1 ¢$σ$¢3();
    }
    interface ¢$\gamma$¢1¢$σ$¢1_Push_¢$\gamma$¢1¢$\gamma$¢1¢$\gamma$¢2<Rest extends C,JR¢$\gamma$¢1 extends C,JR¢$\gamma$¢2 extends C,P extends C¢$\gamma$¢1<Rest, JR¢$\gamma$¢1, JR¢$\gamma$¢2 >>{
      // Sidekick of ¢$\delta(\gamma_1,\sigma_1)=\textsf{push}(\gamma_1,\gamma_1,\gamma_2)$¢
      C¢$\gamma$¢2<C¢$\gamma$¢1<P, Rest, JR¢$\gamma$¢2>,P,JR¢$\gamma$¢2> ¢$σ$¢1();
    }
    interface ¢$\gamma$¢2¢$σ$¢1_Push_¢$\gamma$¢2¢$\gamma$¢2<Rest extends C,JR¢$\gamma$¢1 extends C,JR¢$\gamma$¢2 extends C>{
      // Sidekick of ¢$\delta(\gamma_2,\sigma_1)=\textsf{push}(\gamma_2,\gamma_2)$¢
      C¢$\gamma$¢2<C¢$\gamma$¢2<Rest, JR¢$\gamma$¢1, JR¢$\gamma$¢2>, JR¢$\gamma$¢1, Rest> ¢$σ$¢1();
    }
  }
...
public static abstract class Q<S extends Stack<?>, Top extends ¢$\gammaʹ$¢> {
  private static final class ¢\textcurrency¢ extends Q<Stack<?>, ¢$\gammaʹ$¢.¢\textcurrency¢> {/**/}
  public static final class q0 extends Q<E,¢$\gammaʹ$¢.¢\textcurrency¢>{
    public SingleP_¢$\gamma$¢2<E> ¢$σ$¢1() { return null; }
  }
  public static abstract class q1<S extends Stack<?> , T extends ¢$\gammaʹ$¢> extends Q<S,T> {
    private static final class ¢\textcurrency¢ extends q1<E, ¢$\gammaʹ$¢.¢\textcurrency¢> {/**/}
    public static final class q1_¢$\gamma$¢1<Rest extends Stack<?>> extends q1<P<¢$\gamma$¢1,Rest>,¢$\gamma$¢1> {/**/}
    public static final class q1_¢$\gamma$¢2<Rest extends Stack<?>> extends q1<P<¢$\gamma$¢2,Rest>,¢$\gamma$¢2> {
      public NoOp2<Rest> ¢$σ$¢1() { return null; }
    }
  }
  public static abstract class q2<S extends Stack<?> , T extends ¢$\gammaʹ$¢> extends Q<S,T> {
    public static final class q2_E extends q2<E, ¢$\gammaʹ$¢.¢\textcurrency¢> {
      public DoubleP_¢$\gamma$¢1_¢$\gamma$¢2 ¢$σ$¢1() { return null; }
    }
    public static final class q2_¢$\gamma$¢1<S extends Stack<?>> extends q2<S,¢$\gamma$¢1> {/**/}
    public static final class q2_¢$\gamma$¢2<S extends Stack<?>> extends q2<S,¢$\gamma$¢2> {
      public DoubleP_¢$\gamma$¢1_¢$\gamma$¢1<S> ¢$σ$¢1() { return null; }
    }
  }
  public static abstract class q3<S extends Stack<?>, T extends ¢$\gammaʹ$¢> extends Q<S,T> {
    public static final class q3_¢$\gamma$¢1<Rest extends Stack<?>> extends q3<P<¢$\gamma$¢1,Rest>,¢$\gamma$¢1> {/**/}
    public static final class q3_¢$\gamma$¢2<Rest extends Stack<?>> extends q3<P<¢$\gamma$¢2,Rest>,¢$\gamma$¢2> {/**/}
    private static final class ¢\textcurrency¢ extends q3<E, ¢$\gammaʹ$¢.¢\textcurrency¢> {/**/}
  }
}
\end{filecontents*}
\begin{filecontents*}{stack.listing}
public static abstract class Stack<Rest extends Stack<?>> { 
  public abstract ¢$\gammaʹ$¢ top();      
  public abstract Rest pop();    
  public abstract Stack<?> ¢$\gamma$¢1();  // Push type ¢\cc{\scriptsize $\Gamma'.\Gamma.\gamma1$}¢
  public abstract Stack<?> ¢$\gamma$¢2();  // Push type ¢\cc{\scriptsize $\Gamma'.\Gamma.\gamma2$}¢ 
  public static class P<Top extends ¢$\gamma$¢, Rest extends Stack<?>> 
    extends Stack<Rest> { // Type of a non-empty stack: 
       ...
       @Override public P<¢$\gamma$¢1, P<Top,Rest>> ¢$\gamma$¢1() { return null; } 
       @Override public P<¢$\gamma$¢2, P<Top,Rest>> ¢$\gamma$¢2() { return null; }
  }
  public static final class E 
    extends Stack<¢\textcurrency¢> { // Type of an empty stack
      @Override public ¢$\gammaʹ$¢.¢\textcurrency¢ top() { return null; }
      @Override public ¢\textcurrency¢ pop() { return null; } 
      @Override public P<¢$\gamma$¢1, E> ¢$\gamma$¢1() { return null; } 
      @Override public P<¢$\gamma$¢2, E> ¢$\gamma$¢2() { return null; }
  }
  public static final E empty = null; 
  private static final class ¢\textcurrency¢ 
    extends Stack<¢\textcurrency¢> { // Type of pop from empty stack 
      @Override public ¢$\gammaʹ$¢.¢\textcurrency¢ top() { return null; }
      @Override public ¢\textcurrency¢ pop() { return null; } 
      @Override public ¢\textcurrency¢ ¢$\gamma$¢1() { return null; } 
      @Override public ¢\textcurrency¢ ¢$\gamma$¢2() { return null; }
  }
}
\end{filecontents*}
...
public static void use_case_of_stack() {
  ...
  P<¢$\gamma$¢1, P<¢$\gamma$¢1, P<¢$\gamma$¢2, P<¢$\gamma$¢1, P<¢$\gamma$¢1, E>>>>> _1 = Stack.empty.¢$\gamma$¢1().¢$\gamma$¢1().¢$\gamma$¢2().¢$\gamma$¢1().¢$\gamma$¢1();
  P<¢$\gamma$¢1, P<¢$\gamma$¢2, P<¢$\gamma$¢1, P<¢$\gamma$¢1, E>>>> _2 = _1.pop(); // ¢\cmark¢ Pop one item
  P<¢$\gamma$¢2, P<¢$\gamma$¢1, P<¢$\gamma$¢1, E>>> _3 = _2.pop(); // ¢\cmark¢ Pop another item
  P<¢$\gamma$¢1, P<¢$\gamma$¢1, E>> _4 = _3.pop(); // ¢\cmark¢ Pop yet another item
  P<¢$\gamma$¢1, E> _5 = _4.pop(); // ¢\cmark¢ Pop penultimate item
  ¢$\gamma$¢1 _6 = _5.top(); // ¢\cmark¢ Examine last item
  E _7 = _5.pop(); // ¢\cmark¢ Pop last item
  Stack.¢\textcurrency¢ _8 = _7.pop(); // ¢\xmark¢ Cannot pop from an empty stack
  ¢$\gammaʹ$¢.¢\textcurrency¢ _9 = _7.top(); // ¢\xmark¢ empty stack has no top element
} 
\end{filecontents*}
...
\begin{figure}[H]
  ...
  \begin{tabular}{@{}c@{}c@{}}
    ...
    \hspace{-3ex} \parbox[c]{58ex}{\javaInput[]{jOOQ.java.fragment}}⏎
...
Let~$g:\gamma↛\gamma$ be a partial function,
  from the finite set~$\gamma$ into itself.
We argue that~$g$ can
  be represented using the compile-time mechanism of \Java.
  \cref{Figure:unary-function\ReplaceInThesis{}{-b}} encodes such a partial function for~$\gamma=❴\gamma₁,\gamma₂❵$, where~$g(\gamma₁)=\gamma₂$
  and~$g(\gamma₂)=⊥$, i.e.,~$g(\gamma₂)$ is undefined.†{Unless otherwise stated,
...
\ReplaceInThesis{\begin{figure}[hbt]
  \caption[Type encoding of partial unary function]{\label{Figure:unary-function}    Type encoding of partial function~$g:\gamma↛\gamma$,
    defined by~$\gamma=❴\gamma₁,\gamma₂❵$,~$g(\gamma₁)=\gamma₂$ and~$g(\gamma₂)=⊥$.
  }
  \begin{tabular}{@{}c@{}c@{}c@{}}
    \hspace{-7ex}
    \parbox[c]{0.26\linewidth}{      
      \includegraphics{gil-figures-figure0.pdf}
     }    &
    \hspace{1ex}
    \parbox[c]{0.63\linewidth}{      \javaInput[]{gamma.listing}
    }    &
    \hspace{-18ex}
    \quad
    \parbox[c]{0.51\linewidth}{      \javaInput[minipage,toprule=3pt,leftrule=3pt,bottomrule=3pt]{gamma-example.listing}
    }⏎
\textbf{(a)} type hierarchy & \textbf{(b)} implementation & \hspace{-22ex} \textbf{(c)} use cases
  \end{tabular}
\end{figure}
}{\begin{figure}[hbt]
  \caption[Type hierarchy of partial unary function]{\label{Figure:unary-function-a}    Type hierarchy of partial function~$g:\gamma↛\gamma$,
    defined by~$\gamma=❴\gamma₁,\gamma₂❵$,~$g(\gamma₁)=\gamma₂$ and~$g(\gamma₂)=⊥$.
  }\centering
      \includegraphics{gil-figures-figure1.pdf}
 \end{figure}
\begin{figure}[hbt]
...
Abstract class~\cc{$\gamma$}~†{Remember that \Java admits Unicode characters in identifier names} represents the set~$\gamma$, 
final classes~\cc{$\gamma$1},~\cc{$\gamma$2}
  that extend~\cc{$\gamma$}, represent the actual members of the set~$\gamma$.
The remaining two classes are private final class~\cc{\textcurrency} that stands for an error value,
  and abstract class~\cc{$\gamma'$} that denotes the augmented set~$\gamma∪❴\text{\textcurrency}❵$.
Accordingly, both classes~\cc{\textcurrency} and~\cc{$\gamma$} extend~\cc{$\gamma'$}.†{The use
  of short names, e.g.,~\cc{$\gamma$} instead of \cc{$\gamma'.\gamma$},
...
The use cases in~\cref{Figure:unary-function\ReplaceInThesis{}{-c}}\ReplaceInThesis{(c)}{} explain better
  ...
  An instance of class~\cc{$\gamma$1} returns a value of type~\cc{$\gamma$2} upon
  method call~\cc{g()}, while
  an instance of class~\cc{$\gamma$2} returns a value of our~\kk{private}
  error type~\cc{$\gamma'$.\textcurrency} upon the same call.
...
†{A consequence of these idioms is that the augmented class~\cc{$\gamma'$} is visible to clients.
It can be made~\cc{private}. Just move class~\cc{$\gamma$} to outside of~\cc{$\gamma'$}, defying the second idiom.
}
\end{enumerate}
...
Consider the partial binary function~$f: R⨉S↛\gamma$, defined by
\begin{equation}
  \label{Equation:simple-binary}
  \begin{array}{*3c}
    R=❴r₁,r₂❵ & f(r₁,s₁)=\gamma₁ & f(r₂,s₁)=\gamma₁⏎
    S=❴s₁,s₂❵ & f(r₁,s₂)=\gamma₂ & f(r₂, s₂)=⊥
  \end{array}.
\end{equation}
...
\ReplaceInThesis{\begin{figure}[hbt]
  \caption[Type encoding of partial binary function]{\label{Figure:simple-binary}    Type encoding of partial binary function~$f:R⨉S↛\gamma$,
    where~$R=❴r₁,r₂❵$,~$S=❴s₁,s₂❵$, and~$f$
    is specified by~$f(r₁,s₁)=\gamma₁$,~$f(r₁,s₂)=\gamma₂$,~$f(r₂,s₁)=\gamma₁$, and~$f(r₂, s₂)=⊥$.}
  \begin{tabular}{cc}
    \hspace{-3.5ex}
...
⏎
    ...
    {\textbf{(a)} implementation (except for classes~\cc{$\gamma$},~\cc{$\gamma'$},~\cc{$\gamma$1}, and~\cc{$\gamma$2},
    found in \cref{Figure:unary-function}).}
      & \hspace{-5ex}\textbf{(b)} use cases⏎
  \end{tabular}
\end{figure}
}{\begin{figure}[hbt]
  \caption[Type encoding of partial binary function]{    Type encoding of partial binary function~$f:R⨉S↛\gamma$,
    where~$R=❴r₁,r₂❵$,~$S=❴s₁,s₂❵$, and~$f$
    is specified by~$f(r₁,s₁)=\gamma₁$,~$f(r₁,s₂)=\gamma₂$,~$f(r₂,s₁)=\gamma₁$, and~$f(r₂, s₂)=⊥$
     (except for classes~\cc{$\gamma$},~\cc{$\gamma'$},~\cc{$\gamma$1}, and~\cc{$\gamma$2},
...
Stack elements may be drawn from some abstract set~$\gamma$.
In the figure these are either class~\cc{$\gamma$1}
or class \cc{$\gamma$2} (both defined in \cref{Figure:unary-function\ReplaceInThesis{}{-b}}).
A call to function \cc{$\gamma$}$i$ pushes the type \cc{$\gamma$}$i$
  into the stack, for~$i=1,$.
The expression
\[
  \cc{Stack.empty.$\gamma$1().$\gamma$1().$\gamma$2().$\gamma$1().$\gamma$1()}
\]
represents the sequence of pushing the value~$\gamma₁$ into an
empty stack, followed by~$\gamma₁$,~$\gamma₂$,~$\gamma₁$, and, finally,~$\gamma₁$.
This expression's type is that of variable~\cc{\_1}, i.e.,⏎
\[
 \cc{P<$\gamma$1,P<$\gamma$1,P<$\gamma$2,P<$\gamma$1,P<$\gamma$1,E>>>>>}
\]

A recurring building block occurs in this type: 
  generic type~\cc{P}, \emph{short for ‟Push”}, which takes two parameters:
  \begin{enumerate}
    \item the \emph{top} of the stack, always a subtype of~\cc{$\gamma$},
...
\Cref{Figure:stack-encoding\ReplaceInThesis{}{-a}}\ReplaceInThesis{(a)}{} gives
the type inheritance hierarchy of type \cc{Stack} and its subtypes.
...
\ReplaceInThesis{\begin{figure}[!htb]
  ...
  \begin{tabular}{cc}
    \parbox[c]{0.3\linewidth}{      
      \includegraphics{gil-figures-figure2.pdf}
     } &
    ...
    for classes~\cc{$\gamma$},~\cc{$\gamma'$},~\cc{$\gamma$1}, and~\cc{$\gamma$2}, which is in \cref{Figure:unary-function}).}
  \end{tabular}
\end{figure}
}{\begin{figure}[ht]
  ...
  \label{Figure:stack-encoding-a}
    \centering  
      \includegraphics{gil-figures-figure3.pdf}
\begin{figure}[ht]
  \caption[Type encoding of an unbounded stack data structure]
    {Type encoding of an unbounded stack data structure (except
    for classes~\cc{$\gamma$},~\cc{$\gamma'$},~\cc{$\gamma$1}, and~\cc{$\gamma$2},
...
\begin{itemize}
  \item The type at the top of the stack is precisely the return type of \cc{top()};
        ...
        The return type of \cc{top()} in~\cc{E} is the error value {$\gamma'$.\textcurrency}.
  \item Pushing into the stack is encoded as functions~\cc{$\gamma$1()} and~\cc{$\gamma$2()};
  ...
  \item Since an empty stack cannot be popped, function \cc{pop()} is overridden in~\cc{E} to return
    the \emph{error} type \cc{Stack.\textcurrency}. This type is indeed a kind of a stack, except that each of the four stack
        functions: \cc{top()}, \cc{push()},~\cc{$\gamma$1()}, and,~\cc{$\gamma$2()}, return an appropriate error type.
\end{itemize}
...
A \emph{jump-stack} is a stack data structure whose elements are drawn from a finite set~$\gamma$,
  except that jump-stack supports~$\textsf{jump}(\gamma)$,~$\gamma∈\Gamma$ operations
  (which means ‟repetitively \emph{pop} elements from the stack up
  to and including the first occurrence of~$\gamma$”).

\Cref{Figure:jump} shows the skeleton of type-encoding, in parameterized type \cc{JS},
  of a jump-stack whose elements are drawn from type~\cc{$\gamma$}
  (\ReplaceInThesis{\cref{Figure:unary-function}(b)}{\cref{Figure:unary-function-b}}), i.e., either~\cc{$\gamma$1} or~\cc{$\gamma$2}.
...
In addition \cc{JS} takes~$k=|\gamma|$ type parameters, one for each~$\gamma∈\gamma$,
  which is the type encoding of the jump-stack after a~$\textsf{jump}(\gamma)$
  operation.
In the figure, there are two such parameters: \cc{J\_$\gamma$1}, and
  \cc{J\_$\gamma$2}.

Functions defined in \cc{JS} include not only the standard stack operations: \cc{top()},
\cc{pop()}, \cc{$\gamma1$()} and~\cc{$\gamma2$()} (encoding a push of~$\gammaᵢ$,~$i=1,2$, in general, there are~$k$),
but also~$k$ functions encoding~$\textsf{jump}(\gamma)$,~$\gamma∈\gamma$.
In our case, these are \cc{jump\_$\gamma$1} and \cc{jump\_$\gamma$2},
  which encode~$\textsf{jump}(\gammaᵢ)$
  thanks to their return type being~\cc{J\_$\gamma${}$i$},~$i=1,2$.
...
Two of the specializations are parameter-less and are
  ...
  counterparts:
\cc{JS.E} encodes an empty jump-stack; \cc{JS.\textcurrency} encodes a jump-stack in error,
...
the same \cc{Top} and \cc{Rest} parameters (ll.17--18) as type \cc{Stack.P}:
  ...
  \cc{J\_$\gamma$1} and \cc{J\_$\gamma$2} (ll.19--20)
which are the types encoding the jump-stack
  after the execution~$\textsf{jump}(\gammaᵢ)$,~$i=1,2$.
...
The fifth parameter to \cc{Pʹ} (l.22) is the current incarnation of~\cc{P}, i.e.,
  \cc{P<Top, Rest, J\_$\gamma$1, J\_$\gamma$2}.

The auxiliary (and \kk{private}) type \cc{Pʹ} itself is depicted in \cref{Figure:jump-stack-push}.
By extending type \cc{JS} and passing the correct \cc{Rest} (respectively, \cc{J\_$\gamma$1}, \cc{J\_$\gamma$2})
parameter to it, \cc{Pʹ} inherits correct declaration of function \cc{pop()} (l.8~\cref{Figure:jump})
  (respectively \cc{jump\_$\gamma$1} (l.11 ibid), \cc{jump\_$\gamma$2} (l.12 ibid)).
...
Type \cc{Me} also captures the actual parameters \emph{included} to \cc{JP.P},
  which makes it possible to write the return type of \cc{$\gamma$1()} and \cc{$\gamma$2()} more succinctly.
Let, e.g.,~$τ=\cc{P<$\gamma$1, Me, Me, J\_$\gamma$2>}$ be the return type of \cc{$\gamma$1()}.
The first two parameters to~$τ$ say that pushing~\cc{$\gamma$1},
  results in a compound jump-stack, whose top element is \cc{$\gamma$1},
  and where the rest of the jump-stack is the current type.
The third parameter to~$τ$ says that since \cc{$\gamma$1} was pushed the result
  of a~$\textsf{jump}(\gamma₁)$ is the type of the receiver.
The fourth parameter is \cc{J\_$\gamma$2} since a push of~$\gamma₁$ does not
  change the result of~$\textsf{jump}(\gamma_2)$.
...
The type of variable \cc{\_1} encodes a stack into which \cc{$\gamma$2}, \cc{$\gamma$1}, \cc{$\gamma$1} were pushed
  (in this order).
Examining the type of \cc{\_2} we see that executing \cc{jump\_$\gamma$2} on
  \cc{\_1}, yields the empty stack in a single step.
The type of \cc{\_3} is that state of the same stack
  after executing~\cc{jump\_$\gamma$1};
...
\ReplaceInThesis{\begin{wraptable}r{36ex}
  ...
  {\label{Table:A} The transition function of a jDPDA~$A$,~$Σ=❴σ₁,σ₂,σ₃❵$,~$\gamma=❴\gamma₁,\gamma₂❵$ where~$\gamma₁$ is the initial element}
  \begin{tabular}{c|ll}
  & \hfill~$\gamma₁$ & \hfill~$\gamma₂$⏎
    \midrule
$σ₁$ & $\textsf{push}(\gamma₁,\gamma₁,\gamma₂)$ & $\textsf{push}(\gamma₂,\gamma₂)$⏎
$σ₂$ & \hfill$⊥$ & $\textsf{push}(ε)$⏎
$σ₃$ & \hfill$⊥$ & $\textsf{jump}(\gamma₁)$⏎
...
\begin{itemize}
  ...
  \item $k$ types, named \cc{JR$\gamma$1}, … ,\cc{JR$\gamma${}$k$}, encoding the type of \cc{Rest}
    after~$\textsf{jump}(\gamma₁)$,…~$\textsf{jump}(\gammaₖ)$.
\end{itemize}

Note that these~$k+1$ parameters are sufficient for describing a configuration,
  i.e., if the top is~$\gammaⱼ$, then for all~$j≠i~$
\[
  \textsf{jump}(\gammaⱼ) = \cc{Rest.}\textsf{jump}(\gammaⱼ)
\]
In the special case of~$\textsf{jump}(\gammaᵢ)$ the returned type is still~$\cc{Rest}$,
...
\end{quote}
This excerpt shows also classes~\cc{E} and~\cc{\textcurrency} which encode (as in \cref{Figure:jump})
...
Types \cc{C$\gamma$1}, … ,\cc{C$\gamma${}$k$}, specializing~\cc{C},
  encode stacks whose top element is~$\gamma₁$, … ,$\gammaₖ$.
In~$A$ there are two of these:
\begin{quote}
  \javaInput[minipage,width=\ReplaceInThesis{42ex}{\linewidth},left=-4ex]{proof.many.listing}
\end{quote}

In~$A$, types \cc{C$\gamma$1} and \cc{C$\gamma$2} take three parameters;
...
of all fluent API call chains, to be of type \cc{C$\gamma$1<E,\textcurrency,\textcurrency>}, i.e.,
  the starting configuration of the automaton is a stack whose top is~$\gamma₁$,
  and its \cc{Rest} parameter is empty (\cc{E}).
Any of the two jumps possible on this rest results with,~\cc{\textcurrency},
  an undefined stack.
...
@Override L ¢\gobble$¢$();
  ...
  \item[$\textsf{jump}(\gammaᵢ)$]
  The design of the generic parameters makes the implementation of~$\textsf{jump}(\gammaᵢ)$
    operations particularly simple.
  All that is required is to covariantly change the return type of the
    appropriate \cc{$σ${}$j$()} function to the appropriate \cc{JR$\gamma{}i$} or~\cc{Rest} parameter
  ...
  \par
  In \cref{Table:A} we find that~$δ(\gamma₂,σ₃) =\textsf{jump}(\gamma₁)$. 
  Accordingly, the type of \cc{$σ$2()} in \cc{C$\gamma$2} (l.34) is \cc{JR$\gamma$1}.
  ...
  \par
  Cases in point
    are~$δ(\gamma₁,σ₁)=\textsf{push}(\gamma₁,\gamma₁,\gamma₂)$, and~$δ(\gamma₂,σ₁)=\textsf{push}(\gamma₂,\gamma₂)$ of \cref{Table:A}.
  The corresponding sidekick types,
    (\cc{$\gamma$1$σ$1\_Push\_$\gamma$1$\gamma$1$\gamma$2} and \cc{$\gamma$2$σ$1\_Push\_$\gamma$2$\gamma$2})
    can be found in lines 36--43 of \cref{Figure:A}.
  The first of these define the correct return type
    of \cc{$σ$1()} in case \cc{$\gamma$1} is the top element,
    the second of \cc{$σ$2}, in case \cc{$\gamma$2} is the top element.
  Examine now the definition of types \cc{C$\gamma$1},\cc{C$\gamma$2} in the figure,
  ...
  More generally, economy of expression may require that for each case
    of~$δ(\gamma,σ)=\textsf{push}(ζ)$ in the transition table,
    one creates a sidekick type which overrides the appropriate \cc{$σ$()}
    function.
  The appropriate \cc{C$\gamma$} type then inherits the definition
    from the sidekick.
\end{description}
...
The proof resembles that of~\cref{Theorem:Gil-Levy}.
...
Since the code suggested by the proof is similar to the code presented 
above, only the differences will be discussed.
...
Classes \cc{\textcurrency} and \cc{E} are defined similarly, except now they don't extend any type.

\subsection{Top-of-Stack Types}
Types \cc{C$\gamma$1}, … ,\cc{C$\gamma${}$k$}, still represent stacks
  with \cc{$\gamma$1}, … ,\cc{$\gamma${}$k$} as their top element,
...
Encoding of the legal operations \textsf{accept},~$\textsf{jump}(\gammaᵢ)$ and~$\textsf{push}(ζ)$
...
\begin{description}
 \item[\textsf{reject}] Since we add the methods ad-hock to each type, the reject entry means
   that the corresponding type, \emph{won't} have a~\cc{\$()} method, i.e., type~\cc{C$\gamma$2}
 ...
 \item[$⊥$] We encounter~$⊥$ on the transition function when some input character~\cc{$σ$}
   ...
   In \cref{Table:A} a~$⊥$ may occur when the top of the stack is~$\gamma₁$ and the input character is~$σ₂$,
   thus, no method \cc{$σ$2} is introduced in type~\cc{C$\gamma$1}.
\end{description}
