...
Conversely, with this type definition, compile time type error occurs in \cc{\kk{new} Box.close()},
...
In the box example, this language could be defined by the informal regular expression:
\[
...
We give reason why it is highly unlikely that
