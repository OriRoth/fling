...
\Self generates LR($1$) parsers. Experience shows that these and even the strictly smaller set of 
  LALR grammars is sufficient for many purposes (see e.g., an acknowledgement by T\@. Parr, the developer of LL($*$) grammars
~\cite{Parr:1995}).  
Evidently, Bison{Bison:manual}, 
...
Practicality concerns stop \Self from trying to achieve more.
