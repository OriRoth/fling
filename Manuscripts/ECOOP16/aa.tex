...
Roughly speaking, deterministic context free languages are those context free languages
  that can be recognized by an LR (left-right~\cite{provide:lr:grammars}) parser.
    this is also the set of LL(*) languages~\cite{Knuth:65}, which happens also
...
Still, LR(1) languages make a strict subset of deterministic context-free languages.
