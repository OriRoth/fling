...
The work on SugarJ~\cite{Erdweg:2011} is only one of many others attempts 
...
However, there is a software artifact\urlref{https://github.com/verhas/fluflu}
  that automatically converts generates a fluent API that obeys the transitions 
