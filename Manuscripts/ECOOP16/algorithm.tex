...
\begin{algorithm}[ht]
  \begin{algorithmic}
    ...
    \STATE{$f←❴❵$}
<<<<<<< HEAD
    \FOR{$[ A→α·aβ, b,ℓ]∈q$} % Problem: we add to the function only for non-kernel items, now the distinction is a bit elusive.
...
>>>>>>> c9917f63367bf2354de0c1331bfb24ea06d06160
    \ENDFOR
    \RETURN{$f$}
  \end{algorithmic}
\end{algorithm}
