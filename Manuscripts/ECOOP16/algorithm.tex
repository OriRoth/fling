...
\begin{itemize}
  \item \cref{Algorithm:Closure} work very similarly to the original LR parsing closure algorithms
    the first difference is the address field in each of the items, and the second is the special
    care to epsilon rules, i.e., lines 17--18. Each JLR state contains all items that would be generated
...
The structure of the JLR action table
  ...
  where~$q∈Q$, and~$a∈Σ_\$$, being the next state and
