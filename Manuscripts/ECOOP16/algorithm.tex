...
<<<<<<< HEAD
\paragraph{Failed Solution 3} We cannot solve the problem by changing the function elements from~$\Sigma_\$→¬Q$
  to~$\Sigma_\$⨉Ξ→¬Q$. The reason resides on the identity of the input nonterminal.
  When we build the JLR's transition function, we need to decide to which state we move
=======
...
>>>>>>> 5fa1b9fafff40e6168946ded74af69ebfaa93dad
