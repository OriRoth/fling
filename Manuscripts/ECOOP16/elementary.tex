...
\end{Code}
  ...
  The body of classes \cc{$\Gamma$},\cc{$\Gamma'$} as well the full implementation of classes \cc{$\gamma1$} and \cc{$\gamma2$} is not included here, and is
...
\begin{JAVA}
$\gamma2$ _1 = f.r1().s1().g(); // ¢✓¢
¢\currency¢ _1 = f.r1().s2().g(); // ¢✗¢ compile time error, function ¢\cc{g()}¢ is undefined for type ¢$\gamma2$¢.
