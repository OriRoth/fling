...
The protocol of the type-state \cc{Box} class defined in \cref{Figure:box} is 
...
As mentioned above, tools such as fluflu realize
  type-state based their finite automaton description.
...
Type states are but one kind of a language  
...
As mentioned above, 
>>>>>>> 1fd5d74a3a1fafdcfe3866afe6efd408d5aa552f
\endinput
