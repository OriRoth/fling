...
\end{lcode}\\
Method chaining is means that the same object, \cc{sb} of type \cc{StringBuilder} in the above,
   is the receiver of a chain of methods.
There is syntactic sugar for method chaining in languages such as \Smalltalk.
In \Java, method chaining is made possible by making each variant
  of the method \cc{append} return the receiver, i.e., \kk{this}.
