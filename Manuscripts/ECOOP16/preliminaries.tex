...
Some languages, e.g., \Smalltalk offer syntactic sugar, called \emph{cascading}, for this pattern.
\emph{Method chaining} is a ‟programmer made” syntactic sugar for this pattern:
