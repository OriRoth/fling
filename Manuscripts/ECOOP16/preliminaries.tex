...
\begin{Definition}
  ...
  \slshape
We say a DPDA supplies the \emph{runtime condition} if 
...
A runtime simple-jump deterministic pushdown automaton is a jump-DPDA
  as defined in~\cref{Definition:JDPDA} 
  that supplies~\cref{Definition:runtime}.
