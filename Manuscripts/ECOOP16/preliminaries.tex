...
the same expressive power\footnote{In fact, in terms of language expressiveness, they are equivalent~\cite{Knuth:65}} as LR($1$) parsers}, at a greater toll on resources.
...
Where does \Self compare in terms of grammar expressive power with a popular LL($*$)~\cite{Parr:2011} parser generators such %it was introduced there. you can see at Mendeley, i highlighted it.
