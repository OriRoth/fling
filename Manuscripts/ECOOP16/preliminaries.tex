...
A CFG~$G$ has three components:~$Ξ$< a set of \emph{variables}~$Ξ$ (also called nonterminals),
...
Where does \Self compare in terms of expressive power with of popular LL(*)~\cite{Parr:2011} parser generators such
  ...
  As it turns out, languages of LL(*) do not contain the set of LALR(1) languages~†{As it can't handle left-recursive grammars~\cite{Parr:2011}.},
