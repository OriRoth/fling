...
\]
In the special case of~$\textsf{jump}(γᵢ)$ the returned typed is still~$\cc{Rest}$, % TOMER XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
this is due to the fact that before(which is also required by a pop operation). % TOMER XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
