...
\begin{Definition}[Simple-Jump Single-State Realtime Deterministic Pushdown Automaton]
  ...
  Initially,~$ζ=γ₁$.
  At each steps a jDPDA examines~$σ∈Σ$,
...
As it turns out, every DCF language is recognized by some jDPDA~\cite{Courcelle:77}.
...
In particular let instantiations of generic type \cc{JS} (\cref{Figure:jump}) encode the configuration of a jDPDA and
assume that % text is missing XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXx
