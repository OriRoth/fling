...
\begin{quote}
  \javaInput[left=0ex,minipage,width=67ex]{proof.configuration.listing}
\end{quote}
...
\begin{figure}[htbp]
  ...
  \javaInput[left=-43ex,minipage,listing options={numbers=left,numbersep=5pt},width=\textwidth]{proof.full.listing}
\end{figure}
