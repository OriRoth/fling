...
Let $\textsf{java}$ be a function that translates a terminal $\sigma \in \Sigma$

\begin{Theorem}
  \label{Theorem:SDPDA}
  For every SDPDA~$M$ there exists a set~$J_M$ of \Java type declarations, such that
  the command \[
    \cc{M x = M.build.$\textsf{java}(Σ)$}.\$();
  \]
