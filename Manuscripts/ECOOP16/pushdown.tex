...
CFG languages include regular languages, and are strictly contained in the set
  of ‟context-sensitive” languages~\cite{Hopcroft:79}.
...
\begin{Definition}[Deterministic Pushdown Automaton]
  ...
  At each step, the automaton examines:~$σ$, the next input token, the current state~$q∈Q$, and the element~$γ∈Γ$ at the top of the stack.
...
DCFG languages make a strict container of regular languages,
