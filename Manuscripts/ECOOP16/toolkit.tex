...
It is also possible to encode with \Java types unbounded
  data structure as demonstrated in \cref{Figure:stack-use-cases} featuring
  a use case of a stack of \emph{unbounded} depth.

\begin{figure}[!htp]
  \caption{\label{Figure:stack-use-cases}%
    Use cases of a compile-time stack data structure.
  }
  \javaInput[minipage,left=-2ex,listing style=numbered]{stack-use-cases.listing}
\end{figure}
...
or class \cc{$γ$2} (both defined in \cref{Figure:unary-function}).
...
\Cref{Figure:stack-encoding}(a) gives the type inheritance hierarchy 
...
\begin{figure}[!htb]
  ...
  \begin{tabular}{cc}
    ...
    \hspace{-3ex} \parbox[c]{63ex}{\javaInput[minipage,left=-2ex]{stack.listing}}⏎
