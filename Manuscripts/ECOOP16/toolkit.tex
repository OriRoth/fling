...
\begin{itemize}
  ...
  \item Since empty stack cannot be popped, function \cc{pop()} is overriden in~\cc{E} to return
    the \emph{error} type \cc{Stack.¤}. This type is indeed a kind of a stack, except that all four stack
        functions: \cc{top()}, \cc{push()},~\cc{$γ$1()}, and,~\cc{$γ$2()}, return in turn appropriate error type.
\end{itemize}
