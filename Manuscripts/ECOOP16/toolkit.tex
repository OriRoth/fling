...
\begin{itemize}
  ...
  \item Pushing into the stack is encoded as functions~\cc{$γ$1()} and~\cc{$γ$2()};
        ...
        \par
        As a matter of curiosity, observe that the notion of covariance recurs:
...
However, and unlike \CC, encdoing the full $\lambda$-calculus
is impossible (see below in~\cref{Section:bridge}).
