...
\cc{Peep} has two generic parameters, the first,~\cc{$γ$} of type~\cc{$Γ'$}, is the top of the stack,
  and the second,~\cc{S} of type~\cc{Stack$⟨\text{? extends }\text{Stack}⟨\text{?}⟩⟩$}, represents the whole stack (including former~\cc{$γ$}).
...
\cc{\_4} is the received object, and its first type argument is anonymized (as~\cc{$Γ'$.¤} is defined private)
