...
\cc{_1} a stack state, that represents the series 
...
\cc{_2} is the received peep object, its first type argument is~\cc{$γ_2$},
  while the second is the stack represented by the type of~\cc{_1}.
Notice that as expected, the~\cc{Peek}'s first type argument is the type of the top element of stack~\cc{_1}
