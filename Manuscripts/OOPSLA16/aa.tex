%! TEX root = 00.tex
Fluent APIs~\cite{Fowler:2005,VanDeursen:Klint:2000,Hudak:1997,Fowler:2010} are neat.
There is elegance in self-documenting code snippets such as 
\begin{quote}
    \parbox[c]{44ex}{\javaInput[]{camel-apache.java.fragment}} 
\end{quote}
(a use case of Apache Camel~\cite{Ibsen:Anstey:10}, open-source integration framework),
and, 
\begin{quote}
...
As it turns out, an answer relies on
  in two rather theoretical topics:
