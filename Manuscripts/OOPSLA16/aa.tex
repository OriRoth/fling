...
size. \Fajita is \Java tool that implements this
algorithm.

\Cref{figure:sql-bnf} is a BNF specification of a fluent API for a certain fragment of SQL.
...
These are specified in the first two method calls in the chain where, 
...
Indeed, unlike \CC~\cite{long delted list}, the literature on meta-programming with \Java
generics is minimal. 
