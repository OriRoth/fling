...
\begin{quote}
  \parbox[c]{53ex}{\javaInput[]{../Fragments/EXAMPLE-example.fragment}}⏎
\end{quote}
...
Except for the API required for the calls to~\cc{derive($\cdot$)}, \cc{to($\cdot$)}, \cc{and($\cdot$)} etc.,
...
\begin{quote}
  \parbox[c]{53ex}{\javaInput[]{../Fragments/TERMINALS-example.fragment}}⏎
\end{quote}
