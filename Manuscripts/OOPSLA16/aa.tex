%! TEX root = 00.tex
Using snippets such as \[ some example \] (part of the fluent API of a certain library) and 
\[
another example 
\] 
(part of the fluent API of another thing) are neat.  Designing is complicated,
