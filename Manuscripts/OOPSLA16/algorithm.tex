...
In a way, the JSM is a data structure generalizing the symbol table
  of programming languages with lexical binding.
...
Some examples of the~$\Function Consolidate(·,·)$
for our running example (defined in~\cref{figure:running})
are :

\scriptsize
\[
  \Function Consolidate(
    \; [\<Program> ::=…\cc{;} · \<Definitions> \<Body>] \;,
    \; \cc{label} \;
) = \hfill⏎
