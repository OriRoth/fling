...
of the algorithm is the list of substitutions for each nonterminal% NOT FINISHED WRITING HERE
...
\subsection{The Jumps Data Structure}
\label{section:jump}

It remains to show how the jump operations of \RLLp (lines~5 
and~25 in \cref{algorithm:rll-parser}) are implemented.
...
satisfies~$t∈dᵢ$. The query returns~$⊥$ if no~$t$ is not found in any of
the~$dᵢ$s.
