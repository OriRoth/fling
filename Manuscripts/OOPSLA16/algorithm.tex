...
The top item of a stack (and in particular $S_0$ is represented by a pointer,
...
pre-made string of items as done in line 28 of the \RLLp algorithm. 
...
dynamically scoped language\footnote{a dictionary $d_i$ is a collection of
