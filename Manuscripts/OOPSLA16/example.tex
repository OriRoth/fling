...
\begin{figure}[H]
  ...
  \javaInput[minipage,width=35ex,left=-6ex]{toilette.legal.listing}
\end{figure}
...
\begin{figure}[H]
 \caption{\label{figure:toilette:illegal}
  ...
  \javaInput[minipage,width=53ex,left=-6ex]{toilette.illegal.listing}
\end{figure}
...
\begin{figure}
  ...
  \javaInput[minipage,width=41ex,left=-4ex]{toilette.types.listing}
\end{figure}
