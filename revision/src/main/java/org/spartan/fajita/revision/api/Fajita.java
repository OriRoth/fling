...
@SuppressWarnings("synthetic-access") public class Fajita {
  private final Set<DerivationRule> derivationRules;
  private final Set<Terminal> terminals;
  private final Set<Verb> verbs;
  private final Set<NonTerminal> nonTerminals;
  private final Set<Extendible> extendibles;
...
//      super(symbols);
//    }
//    @SuppressWarnings("hiding") public ENonTerminal bind(Fajita builder, NonTerminal lhs) {
