...
public class S {
  ...
  private static class $$$ extends FluentAPIRecorder implements RULE_1, RULE_1_n1, BODY_1, BODY_2, LITERALS_1, RULE_1_n1_rec_1bb, RULE_1_rec_57 {
    $$$() {
      super(new org.spartan.fajita.revision.examples.Datalog().bnf().bnf().getSubBNF(org.spartan.fajita.revision.examples.Datalog.NT.S));}
