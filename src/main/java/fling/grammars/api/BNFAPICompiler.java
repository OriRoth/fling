...
@SuppressWarnings("all") public interface BNFAPICompiler {
  public static PlainBNF parse_PlainBNF(List<fling.internal.compiler.Assignment> w) {
  ...
  public static Rule parse_Rule(List<fling.internal.compiler.Assignment> w) {
  ...
  public static RuleBody parse_RuleBody(List<fling.internal.compiler.Assignment> w) {
    fling.internal.compiler.Assignment _a = w.get(0);
  ...
  public static RuleTail parse_RuleTail(List<fling.internal.compiler.Assignment> w) {
    fling.internal.compiler.Assignment _a = w.get(0);
  ...
  public static Derivation parse_Rule1(List<fling.internal.compiler.Assignment> w) {
    fling.internal.compiler.Assignment _a;
    List<?> _b;
    _a = w.remove(0);
    Variable variable = (Variable) _a.arguments.get(0);
  ...
  public static Specialization parse_Rule2(List<fling.internal.compiler.Assignment> w) {
    fling.internal.compiler.Assignment _a;
    List<?> _b;
    _a = w.remove(0);
    Variable variable = (Variable) _a.arguments.get(0);
  ...
  public static ConcreteDerivation parse_RuleBody1(List<fling.internal.compiler.Assignment> w) {
    fling.internal.compiler.Assignment _a;
    List<?> _b;
    _a = w.remove(0);
  ...
  public static EpsilonDerivation parse_RuleBody2(List<fling.internal.compiler.Assignment> w) {
    fling.internal.compiler.Assignment _a;
    List<?> _b;
    _a = w.remove(0);
    return new EpsilonDerivation();
  }
  public static ConcreteDerivationTail parse_RuleTail1(List<fling.internal.compiler.Assignment> w) {
    fling.internal.compiler.Assignment _a;
    List<?> _b;
    _a = w.remove(0);
    Symbol[] symbols = (Symbol[]) _a.arguments.get(0);
  ...
  public static EpsilonDerivationTail parse_RuleTail2(List<fling.internal.compiler.Assignment> w) {
    fling.internal.compiler.Assignment _a;
    List<?> _b;
    _a = w.remove(0);
    return new EpsilonDerivationTail();
  }
  public static List<Object> parse__Rule2(List<fling.internal.compiler.Assignment> w) {
    fling.internal.compiler.Assignment _a;
    List<Object> _b;
    if (w.isEmpty())
  ...
  public static List<Object> parse__RuleTail2(List<fling.internal.compiler.Assignment> w) {
    fling.internal.compiler.Assignment _a;
    List<Object> _b;
    if (w.isEmpty())
      return java.util.Collections.emptyList();
