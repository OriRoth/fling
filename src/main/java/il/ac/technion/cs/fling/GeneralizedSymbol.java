...
public interface GeneralizedSymbol extends Named {
  ...
  static Optional optional(final GeneralizedSymbol symbol) {
    return new Optional(!symbol.isTerminal() ? symbol : new Verb(symbol.asTerminal()));
  }
  static NoneOrMore noneOrMore(final GeneralizedSymbol symbol) {
    return new NoneOrMore(!symbol.isTerminal() ? symbol : new Verb(symbol.asTerminal()));
  }
  static OneOrMore oneOrMore(final GeneralizedSymbol symbol) {
