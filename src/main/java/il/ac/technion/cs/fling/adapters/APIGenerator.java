...
public abstract class APIGenerator extends Indenter {
  ...
  final String render(Type.Instantiation i) {
  ...
  public abstract String renderInstnatiation(Type.Name name, List<Type.Instantiation> arguments);
  ...
  public abstract String toString(Type.Instantiation.Plain.Parametrized i);
  public abstract String toString(Type.Instantiation.Plain i);
