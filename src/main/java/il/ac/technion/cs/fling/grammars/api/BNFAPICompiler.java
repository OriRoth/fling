...
@SuppressWarnings("all") public interface BNFAPICompiler {
  static PlainBNF parse_PlainBNF(final List<il.ac.technion.cs.fling.internal.compiler.Assignment> w) {
  ...
  static Rule parse_Rule(final List<il.ac.technion.cs.fling.internal.compiler.Assignment> w) {
    final il.ac.technion.cs.fling.internal.compiler.Assignment _a = w.get(0);
  ...
  static RuleBody parse_RuleBody(final List<il.ac.technion.cs.fling.internal.compiler.Assignment> w) {
    final il.ac.technion.cs.fling.internal.compiler.Assignment _a = w.get(0);
  ...
  static RuleTail parse_RuleTail(final List<il.ac.technion.cs.fling.internal.compiler.Assignment> w) {
    final il.ac.technion.cs.fling.internal.compiler.Assignment _a = w.get(0);
  ...
  static Derivation parse_Rule1(final List<il.ac.technion.cs.fling.internal.compiler.Assignment> w) {
    il.ac.technion.cs.fling.internal.compiler.Assignment _a;
    _a = w.remove(0);
    final Variable variable = (Variable) _a.arguments.get(0);
  ...
  static Specialization parse_Rule2(final List<il.ac.technion.cs.fling.internal.compiler.Assignment> w) {
    il.ac.technion.cs.fling.internal.compiler.Assignment _a;
    _a = w.remove(0);
    final Variable variable = (Variable) _a.arguments.get(0);
    _a = w.remove(0);
  ...
  static ConcreteDerivation parse_RuleBody1(final List<il.ac.technion.cs.fling.internal.compiler.Assignment> w) {
    il.ac.technion.cs.fling.internal.compiler.Assignment _a;
    List<?> _b;
    _a = w.remove(0);
  ...
  static EpsilonDerivation parse_RuleBody2(final List<il.ac.technion.cs.fling.internal.compiler.Assignment> w) {
    w.remove(0);
    return new EpsilonDerivation();
  }

  static ConcreteDerivationTail parse_RuleTail1(final List<il.ac.technion.cs.fling.internal.compiler.Assignment> w) {
    il.ac.technion.cs.fling.internal.compiler.Assignment _a;
    _a = w.remove(0);
  ...
  static EpsilonDerivationTail parse_RuleTail2(final List<il.ac.technion.cs.fling.internal.compiler.Assignment> w) {
    w.remove(0);
    return new EpsilonDerivationTail();
  }

  static List<Object> parse__Rule2(final List<il.ac.technion.cs.fling.internal.compiler.Assignment> w) {
    il.ac.technion.cs.fling.internal.compiler.Assignment _a;
    if (w.isEmpty())
  ...
  static List<Object> parse__RuleTail2(final List<il.ac.technion.cs.fling.internal.compiler.Assignment> w) {
    il.ac.technion.cs.fling.internal.compiler.Assignment _a;
    if (w.isEmpty())
      return java.util.Collections.emptyList();
    _a = w.get(0);
