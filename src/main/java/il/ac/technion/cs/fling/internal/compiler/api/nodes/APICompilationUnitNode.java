...
public class APICompilationUnitNode<T, D, N> {
  ...
  public APICompilationUnitNode(final List<AbstractMethodNode<T, D>> startMethods,
      final List<InterfaceNode<T, D, N>> interfaces, final ConcreteImplementationNode<T, D> concreteImplementation) {
