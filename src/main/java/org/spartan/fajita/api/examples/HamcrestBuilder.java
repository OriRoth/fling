...
public class HamcrestBuilder {
    ...
    static class Matcher<T> extends InheritedNonterminal implements IMatcher {
	// for top-down
	...
	S(final T value, final CompoundMatcher<T> m) {
	    super(null);
	...
	@SuppressWarnings("unchecked")
	AssertThat(final Compound parent, final T value, final Compound c) {
	    super(parent);
	...
	// for top-down
	@SuppressWarnings("unchecked")
	InstaceOf(final Matcher<T> parent, final Class<? extends T> type) {
	    super(parent);
	...
	// for top-down
	@SuppressWarnings("unchecked")
	EqualTo(final Matcher<T> parent, final T value) {
	    super(parent);
	...
	public static class AnyOf<T> extends CompoundMatcher<T> {
	    ...
	    // for top-down
	    @SuppressWarnings("unchecked")
	    AnyOf(final Matcher<T> parent, final CompoundMatcher<T>[] matchers) {
		super(parent);
