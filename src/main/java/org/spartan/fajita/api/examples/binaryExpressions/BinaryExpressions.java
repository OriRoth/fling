...
//      super(parent);
//      ((Expr) child(0)).deriveTo(e1);
//      ((Expr) child(2)).deriveTo(e2);
//    }
...
//    }
//    public Literal bool(final boolean b) {
//      return new Literal((Expr) child(1), b);
//    }
//    public Not not() {
//      return new Not((Expr) child(1));
//    }
//    @Override public String getName() {
//      return "NOT";
//    }
...
//      ((Expr) and.child(0)).deriveTo(this);
//      return (Expr) and.child(2);
//    }
//    public Expr or() {
//      if (getParent() == null)
//        setParent(new Expr());
...
//      ((Expr) or.child(0)).deriveTo(this);
//      return (Expr) or.child(2);
//    }
//    @Override public String getName() {
//      return "LITERAL";
//    }
