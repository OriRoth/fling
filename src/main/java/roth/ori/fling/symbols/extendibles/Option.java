...
public class Option extends Either {
  public Option(List<GrammarElement> symbols) {
    super(symbols);
  }
  ...
  @Override protected boolean isNullable(@SuppressWarnings("unused") Set<GrammarElement> knownNullables) {
    return true;
  }
  @Override public List<String> parseTypes(@SuppressWarnings("unused") Function<GrammarElement, List<String>> operation,
