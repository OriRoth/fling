...
// .finish();
// DerivationRule S_Rule = findRule(bnf, lookahead ->
// lookahead.lhs.equals(NT.S));
// DerivationRule A_Rule = findRule(bnf, lookahead ->
// lookahead.lhs.equals(NT.A));
...
// .finish();
// // fetching the rules
// DerivationRule StoA_Rule = findRule(bnf, lookahead ->
// lookahead.lhs.equals(NT2.S) &&
// lookahead.getChildren().get(0).equals(NT2.A));
// DerivationRule StoB_Rule = findRule(bnf, lookahead ->
// lookahead.lhs.equals(NT2.S) &&
// lookahead.getChildren().get(0).equals(NT2.B));
// DerivationRule StoC_Rule = findRule(bnf, lookahead ->
// lookahead.lhs.equals(NT2.S) &&
// lookahead.getChildren().get(0).equals(NT2.C));
// DerivationRule A_Rule = findRule(bnf, lookahead ->
// lookahead.lhs.equals(NT2.A));
// DerivationRule B_Rule = findRule(bnf, lookahead ->
// lookahead.lhs.equals(NT2.B));
// DerivationRule C_Rule = findRule(bnf, lookahead ->
// lookahead.lhs.equals(NT2.C));
// // test
...
// return findRule(bnf, lookahead ->
// lookahead.lhs.equals(bnf.getAugmentedStartSymbol()));
// }
...
// .finish();
// // fetching the rules
// DerivationRule AtoB_Rule = findRule(bnf, lookahead ->
// lookahead.lhs.equals(NT2.A) &&
// lookahead.getChildren().get(0).equals(NT2.B));
// DerivationRule AtoC_Rule = findRule(bnf, lookahead ->
// lookahead.lhs.equals(NT2.A) &&
// lookahead.getChildren().get(0).equals(NT2.C));
// DerivationRule S_Rule = findRule(bnf, lookahead ->
// lookahead.lhs.equals(NT2.S));
