...
// assertEquals(parser.actionTable(parser.getInitialState(),
// Term.id).getClass(), Shift.class);
// }
...
// assertEquals(parser.actionTable(nextState, Term.plus).getClass(),
// Reduce.class);
// }
// @SuppressWarnings({ "static-method",
// "unused" }) @Test(expected = ShiftReduceConflictException.class) public void
...
// }
// @SuppressWarnings({ "static-method",
// "unused" }) @Test(expected = ReduceReduceConflictException.class) public void
